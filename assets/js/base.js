	...
	array.forEach(object=>{	
		 ...
		 document.getElementById("href-0"+x).href="./proyectos.html?proyecto=" + object.codigo + "";
		 document.getElementById("imagen-0"+x).src="assets/imagenes/" + object.codigo + "-portada.jpg";
		 
		 
		 document.getElementById('titulo-portada-0'+x).innerHTML = object.tituloportada;
